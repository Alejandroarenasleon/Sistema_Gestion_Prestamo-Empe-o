...
return [
    ...
    */
    ...
    'ascii'                => 'El campo :attribute solo debe contener caracteres alfanuméricos ASCII de 7 bits.',
    ...
    'contains'             => 'El campo :attribute debe contener :values.',
    'current_password'     => 'La contraseña es incorrecta.',
    'date'                 => 'El campo :attribute no es una fecha válida.',
    'date_equals'          => 'El campo :attribute debe ser una fecha igual a :date.',
    'date_format'          => 'El campo :attribute no coincide con el formato :format.',
    'decimal'              => 'El campo :attribute debe tener :places lugares decimales.',
    ...
    'password'             => [
        ...
        'uncompromised' => 'La contraseña dada ha aparecido en una filtración de datos. Por favor, elija una contraseña diferente.',
    ],
    ...
    | convention "attribute.rule". This is a quick way to specify custom
    | language lines for a given attribute.
    |
    */

    'custom' => [
        'celular' => [
            'regex' => 'El celular solo puede contener números, espacios, guiones, paréntesis y el signo +.',
        ],
        'password' => [
    ...
    | of "email". This simply helps us make our validation messages a bit
    ...
    */
    ...
    'attributes' => [
        ...
        'direccion' => 'dirección',
        'celular' => 'celular',
        'referencia_contacto' => 'referencia de contacto',
        'foto_ci_anverso' => 'foto CI anverso',
        'foto_ci_reverso' => 'foto CI reverso',
        ...
        'prendas' => 'prendas',
        'prendas.*.categoria' => 'categoría de la prenda',
        'prendas.*.descripcion' => 'descripción de la prenda',
        'prendas.*.avaluo' => 'avalúo de la prenda',
        'prendas.*.peso_gramos' => 'peso de la prenda',
        'prendas.*.numero_serie_imei' => 'serie/IMEI de la prenda',
        'id_prestamo' => 'préstamo',
        'tipo' => 'tipo de cobro',
        'monto' => 'monto',
        'nueva_fecha_vencimiento' => 'nueva fecha de vencimiento',
        'quilate' => 'quilate',
